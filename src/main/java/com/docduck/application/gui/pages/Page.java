...
public class Page extends BorderPane {
    ...
    protected final Color backgroundColour = Color.web("#ffffff"); // Light grey for main background
    protected final Color boxColour = Color.web("#f0f0f0"); // White for div background
    protected final Color btnColour = Color.web("#ffffff"); // Medium grey for button background
    protected final Color btnHoverColour = Color.web("#a0a0a0"); // Slightly darker grey for button hover
    ...
    protected final Color barColour = Color.web("#bdc3c7"); // Lighter pastel grey
